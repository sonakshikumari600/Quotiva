...
- JavaScript - Theme switching, favorites, and interactive features
- Local Storage - Stores theme preferences and favorite quotes

## Features

- Browse inspirational quotes
- Save favorite quotes
- Multiple pastel themes
- Responsive design
- About, Privacy, Sources, and Tips popups
